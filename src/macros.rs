...
macro_rules! interchange {
    ...
    ($Name:ident: ($REQUEST:ty, $RESPONSE:ty, $N:expr)) => {
        ...
        impl $Name {
            ...
            fn last_claimed() -> &'static portable_atomic::AtomicUsize {
        ...
        impl $crate::Interchange for $Name {
            ...
            unsafe fn reset_claims() {
                ...
                //     Self::last_claimed().load( portable_atomic::Ordering::SeqCst));
                Self::last_claimed().store(0, portable_atomic::Ordering::SeqCst);
            ...
            fn unclaimed_clients() -> usize {
                Self::CLIENT_CAPACITY - Self::last_claimed().load(portable_atomic::Ordering::SeqCst)
            }
